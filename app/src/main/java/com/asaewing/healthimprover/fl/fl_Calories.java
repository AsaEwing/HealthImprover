    ...
    public void fabOpen(boolean fabMain) {
        ...
        if (fabFlag) {
            ...
            fabCal_Run.animate().alpha(1f).scaleX(1f).scaleY(1f)
                    ...
                    //.translationX(-(float)(MainActivity.fabMain.getWidth()*1.1)).setDuration(360)
                    .setListener(new Animator.AnimatorListener() {
                @Override
                public void onAnimationStart(Animator animation) {
            ...
            fabCal_Bike.animate().alpha(1f).scaleX(1f).scaleY(1f)
                    ...
                    //.translationY(-(float)(MainActivity.fabMain.getWidth()*1.1)).setDuration(360)
                    .setListener(new Animator.AnimatorListener() {
                        @Override
                        public void onAnimationStart(Animator animation) {
            ...
            fabCal_Swim.animate().alpha(1f).scaleX(1f).scaleY(1f)
                    ...
                    //.translationX(-(float)(MainActivity.fabMain.getWidth()*1.1*0.707))
                    //.translationY(-(float)(MainActivity.fabMain.getWidth()*1.1*0.707))
                    .setDuration(360)
                    .setListener(new Animator.AnimatorListener() {
                        @Override
                        public void onAnimationStart(Animator animation) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.fabCal_Run:
                ...
                //MainActivity.volleyMethod.vpost_GetCalInRecord("","2016-7-15");
