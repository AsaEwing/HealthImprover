...
import com.asaewing.healthimprover.Others.CirclePageIndicator;
import com.asaewing.healthimprover.Others.InfoMap;
import com.asaewing.healthimprover.Others.TypeTextView;
import com.asaewing.healthimprover.ViewPager.ViewPagerAdapter;
import com.asaewing.healthimprover.ViewPager.ViewPagerItem;
import com.asaewing.healthimprover.fl.fl_AR_Exp;
import com.asaewing.healthimprover.fl.fl_Calories2;
import com.asaewing.healthimprover.fl.fl_Camera;
import com.asaewing.healthimprover.fl.fl_BasicInfo;
//import com.asaewing.healthimprover.fl.fl_Calories;
import com.asaewing.healthimprover.fl.fl_Chat;
import com.asaewing.healthimprover.fl.fl_Diary;
import com.asaewing.healthimprover.fl.fl_Heart;
import com.asaewing.healthimprover.fl.fl_MyDevice;
import com.asaewing.healthimprover.fl.fl_Note;
import com.asaewing.healthimprover.fl.fl_Notification;
import com.asaewing.healthimprover.fl.fl_ProductTour;
import com.asaewing.healthimprover.fl.fl_Record;
import com.asaewing.healthimprover.fl.fl_Settings;
import com.asaewing.healthimprover.fl.fl_Sleep;
import com.asaewing.healthimprover.fl.fl_Test01;
import com.asaewing.healthimprover.fl.fl_Test02;
...
public class RootActivity extends AppCompatActivity
    ...
    //TODO----Self----
    /** flIdToStringChange>>負責將nav傳過來的id轉成string **/
    protected String flIdToStringChange(int nav_id) {
        ...
        Log.d(TAG,"**"+TAG+"**flIdToStringChange**"+nav_id+"**"+nav_s);

        return nav_s;
    }

    /** flIdToStringChange>>負責將nav傳過來的String轉成Id **/
    ...
    /** flStringToFragment>>負責fl轉換，Fragment轉換 **/
    @Nullable
    private Fragment flStringToFragment(String nav_s) {
        switch (nav_s) {
            case "fl_Chat":
    ...
    /** flStringToTitle>>負責fl轉換，Title轉換 **/
    @Nullable
    private String flStringToTitle(String nav_s) {
        switch (nav_s) {
            case "fl_Diary":
                return getString(R.string.nav_Diary);

            case "fl_Calories":
                return getString(R.string.nav_Calories);

            case "fl_Sleep":
                return getString(R.string.nav_Sleep);

            case "fl_Chat":
                return getString(R.string.nav_Chat);

            case "fl_BasicInfo":
                return getString(R.string.nav_BasicInfo);

            case "fl_MyDevice":
                return getString(R.string.nav_MyDevice);

            case "fl_Heart":
                return getString(R.string.nav_Heart);

            case "fl_ProductTour":
                return getString(R.string.nav_ProductTour);

            case "fl_AR_Exp":
                return getString(R.string.nav_AR_Exp);

            case "fl_Settings":
                return getString(R.string.nav_Settings);

            case "fl_Test01":
                return getString(R.string.nav_Test01);

            case "fl_Test02":
                return getString(R.string.nav_Test02);
          ...
          //      return getString(R.string.nav_Item);
            ...
            case "fl_Note":
                return getString(R.string.nav_Note);
            case "fl_Camera":
                return getString(R.string.nav_Camera);
            case "fl_Notification":
                return getString(R.string.nav_Notification);
            case "fl_Record":
                return getString(R.string.nav_Record);
    ...
    public void flChange(String nav_s) {
        ...
        if (nav_s.equals("fl_navHome")) {
            ...
            if (nav_s.equals("fl_Map")) {
                ...
                fragment = flStringToFragment(nav_s);
                sTitle = flStringToTitle(nav_s);
            }
        }
        ...
        if (fl_flag_now.equals("fl_navHome")) {
            ...
            if (fl_flag_now.equals("fl_Map")) {
                ...
                mapFragment.getMapAsync(RootActivity.this);
